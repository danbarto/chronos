...
arrs = [ak.flatten(ge_phi),ak.flatten(ge_phi100),ak.flatten(ge_phi0)]
xlabel = r'Gen Ele $\phi$'
...
fig.savefig('/home/users/hswanson13/public_html/General_Particle_Info/gen_e_phi.png')