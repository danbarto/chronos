...
MTDCellTime = ak.flatten(events['reco_photon_MTDnCells'])

#Cluster Time
MTDCluTime = ak.flatten(events['reco_photon_MTDnClus'])
...
xlabel = 'Number of MTD Hits per Event'
...
fig.savefig('/home/users/hswanson13/public_html/MTD_timing_hists/MTD_nCellnClu.png')