...
tdiff_arrs = [np.clip(ak.flatten(tdiff1000[0]),bin_start,bin_end-0.2),np.clip(ak.flatten(tdiff100[0]),bin_start,bin_end-0.2),np.clip(ak.flatten(tdiff0[0]),bin_start,bin_end-0.2)]

names = [r'$c\tau$=1000mm',r'$c\tau$=100mm',r'$c\tau$=0mm']
colors = ['b','r','g']

arrs = tdiff_arrs
xlabel = 'Matched Photon Time - Matched Gen Ele Time (ns)'
...
fig.savefig('/home/users/hswanson13/public_html/MTD_timing_hists/tdiff_matched_gen_e_and_reco_photons.png')